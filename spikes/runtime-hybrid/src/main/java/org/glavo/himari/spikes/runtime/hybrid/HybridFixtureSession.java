...
/// Provides command, observation, transaction, diagnostic, and cleanup plumbing for hybrid apps.
@NotNullByDefault
abstract class HybridFixtureSession implements RuntimeFixtureSession {
    ...
    /// The candidate-specific hybrid owner runtime.
    private final HybridRuntime runtime;

    /// Whether the hybrid root has mounted.
    ...
    protected HybridFixtureSession(ComparisonEnvironment environment, ComparisonProbe probe) {
        Objects.requireNonNull(environment, "environment");
        this.domain = environment.stateDomain();
        this.probe = Objects.requireNonNull(probe, "probe");
        this.runtime = new HybridRuntime(probe);
    }
    ...
    public final void execute(FixtureCommand command) {
        ...
        } catch (HybridRuntime.HybridMutationException failure) {
    ...
    /// Returns live hybrid-runtime resources, or the clean sentinel after closure.
    ///
    ...
    protected abstract void initialize(HybridRuntime.Owner root);
    ...
    /// Releases application resources not owned by the hybrid tree.
    ...
    protected final void traceDiagnostic(String code, String ownerPath, String recoveryAction) {
        ...
        probe.trace(new DiagnosticTrace(
                code,
                "Hybrid application callback failed inside its declared boundary",
                "hybrid-app",
                ownerPath,
                null,
                recoveryAction
