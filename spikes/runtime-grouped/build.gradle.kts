...
val conformanceDirectory = rootProject.layout.buildDirectory.dir("conformance/m1-runtime-grouped")

tasks.register<JavaExec>("conformance") {
    group = "verification"
    description = "Runs the explicit grouped-recomposition candidate against the frozen M1 suite."
    dependsOn("classes", "test", "pureJavaGuard")
    classpath = sourceSets.named("main").get().runtimeClasspath
    mainClass.set("org.glavo.himari.spikes.runtime.grouped.GroupedRuntimeConformance")
