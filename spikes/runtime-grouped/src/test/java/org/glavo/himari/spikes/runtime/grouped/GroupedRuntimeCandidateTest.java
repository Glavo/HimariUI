...
/// Verifies the complete explicit-grouped candidate against the frozen neutral suite.
@NotNullByDefault
final class GroupedRuntimeCandidateTest {
    ...
    void passesEveryFrozenFixtureWithoutClaimingExternalEvidence() {
        ...
        assertTrue(report.sourceMetrics().ceremonyCounts().get("groupBoundaries") > 0L);
    }
