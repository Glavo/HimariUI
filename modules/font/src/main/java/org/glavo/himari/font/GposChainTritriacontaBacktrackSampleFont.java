...
@NotNullByDefault
public final class GposChainTritriacontaBacktrackSampleFont {
    ...
    private static final int GLYPH_COUNT = 38;

    /// Prevents instantiation.
    private GposChainTritriacontaBacktrackSampleFont() {
    }
    ...
    /// Writes thirty-three rectangles.
    ...
    private static byte[] name() {
        byte[] family = "HimariChain33Back".getBytes(StandardCharsets.US_ASCII);
