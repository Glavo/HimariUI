...
@NotNullByDefault
public final class GsubChainEnneadecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`V` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `VUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain19Back".getBytes(StandardCharsets.US_ASCII);
