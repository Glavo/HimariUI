...
@NotNullByDefault
public final class GsubChainTricosaBacktrackSampleFont {
    ...
    private GsubChainTricosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digit `0`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain23Back".getBytes(StandardCharsets.US_ASCII);
