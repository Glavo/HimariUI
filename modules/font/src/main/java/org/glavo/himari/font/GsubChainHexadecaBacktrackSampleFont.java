...
@NotNullByDefault
public final class GsubChainHexadecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`S` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `SRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain16Back".getBytes(StandardCharsets.US_ASCII);
