...
@NotNullByDefault
public final class GsubChainHexatriacontaBacktrackSampleFont {
    ...
    private GsubChainHexatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain36Back".getBytes(StandardCharsets.US_ASCII);
