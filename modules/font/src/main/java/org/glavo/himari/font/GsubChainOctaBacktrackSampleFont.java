...
@NotNullByDefault
public final class GsubChainOctaBacktrackSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `KJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain8Back".getBytes(StandardCharsets.US_ASCII);
