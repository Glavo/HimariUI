...
/// `wght` applies an ItemVariationStore delta of `3` so [`ColorLayer#transformDx()`] is `5`.
@NotNullByDefault
public final class ColrV1VarTransformDxDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default transform `dx` before variation, as `16.16` units.
    public static final int BASE_TRANSFORM_DX = 2;
    ...
    private ColrV1VarTransformDxDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        buffer.putInt(0);
        buffer.putInt(0);
        buffer.putInt(BASE_TRANSFORM_DX);
        buffer.putInt(0);
        buffer.putInt(0);
