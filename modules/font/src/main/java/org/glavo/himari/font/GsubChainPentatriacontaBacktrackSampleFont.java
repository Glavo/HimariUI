...
@NotNullByDefault
public final class GsubChainPentatriacontaBacktrackSampleFont {
    ...
    private GsubChainPentatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain35Back".getBytes(StandardCharsets.US_ASCII);
