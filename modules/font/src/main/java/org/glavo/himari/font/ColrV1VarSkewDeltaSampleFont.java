...
/// [`ColorLayer#skewX()`] is `5`.
@NotNullByDefault
public final class ColrV1VarSkewDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default skew X angle before variation, as `F2DOT14`.
    ...
    private ColrV1VarSkewDeltaSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariColrVarSkew".getBytes(StandardCharsets.US_ASCII);
