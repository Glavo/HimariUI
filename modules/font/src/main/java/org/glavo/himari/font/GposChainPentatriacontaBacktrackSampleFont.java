...
@NotNullByDefault
public final class GposChainPentatriacontaBacktrackSampleFont {
    ...
    private static final int GLYPH_COUNT = 40;

    /// Prevents instantiation.
    private GposChainPentatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] cmap() {
        ByteBuffer buffer = ByteBuffer.allocate(104).order(ByteOrder.BIG_ENDIAN);
    ...
    private static byte[] name() {
        byte[] family = "HimariChain35Back".getBytes(StandardCharsets.US_ASCII);
