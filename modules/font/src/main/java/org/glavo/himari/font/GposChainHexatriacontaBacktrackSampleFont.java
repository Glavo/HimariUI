...
@NotNullByDefault
public final class GposChainHexatriacontaBacktrackSampleFont {
    ...
    private static final int GLYPH_COUNT = 41;

    /// Prevents instantiation.
    private GposChainHexatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] cmap() {
        ByteBuffer buffer = ByteBuffer.allocate(106).order(ByteOrder.BIG_ENDIAN);
    ...
    private static byte[] name() {
        byte[] family = "HimariChain36Back".getBytes(StandardCharsets.US_ASCII);
