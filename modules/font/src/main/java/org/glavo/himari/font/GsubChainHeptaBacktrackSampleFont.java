...
@NotNullByDefault
public final class GsubChainHeptaBacktrackSampleFont {
    ...
    private GsubChainHeptaBacktrackSampleFont() {
    }
    ...
    /// Writes ChainContextSubst format 1 for `JIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain7Back".getBytes(StandardCharsets.US_ASCII);
