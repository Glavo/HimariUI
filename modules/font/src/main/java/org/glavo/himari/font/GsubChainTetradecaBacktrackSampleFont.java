...
@NotNullByDefault
public final class GsubChainTetradecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`Q` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `QPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain14Back".getBytes(StandardCharsets.US_ASCII);
