...
/// is `5`.
@NotNullByDefault
public final class ColrV1VarRotateCenterDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default around-center X before variation.
    public static final int BASE_CENTER_X = 2;

    /// ItemVariationStore delta applied to center X at peak `wght`.
    ...
    private ColrV1VarRotateCenterDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        putOffset24(buffer, 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) BASE_CENTER_X);
        buffer.putShort((short) 0);
        buffer.putInt(0);
    ...
    private static byte[] name() {
        byte[] family = "HimariColrVarCx".getBytes(StandardCharsets.US_ASCII);
