...
@NotNullByDefault
public final class GsubChainEnneatriacontaBacktrackSampleFont {
    ...
    private GsubChainEnneatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain39Back".getBytes(StandardCharsets.US_ASCII);
