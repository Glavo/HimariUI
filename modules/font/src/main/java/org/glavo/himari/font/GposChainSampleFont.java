...
/// Generates a face whose GPOS type-8 `ABC` rule applies [`#CHAIN_DELTA`] to `A`.
///
/// Lookup 0 is the chain rule listed by `kern`. Lookup 1 is a nested type-1 X-advance.
@NotNullByDefault
public final class GposChainSampleFont {
    ...
    /// Writes ChainContextPos format 1 for `ABC`.
    ...
    private static byte[] name() {
        byte[] family = "HimariChain".getBytes(StandardCharsets.US_ASCII);
