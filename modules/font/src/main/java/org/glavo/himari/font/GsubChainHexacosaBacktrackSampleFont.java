...
@NotNullByDefault
public final class GsubChainHexacosaBacktrackSampleFont {
    ...
    private GsubChainHexacosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`3`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain26Back".getBytes(StandardCharsets.US_ASCII);
