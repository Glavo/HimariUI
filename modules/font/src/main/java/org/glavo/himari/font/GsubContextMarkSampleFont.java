...
/// Generates a face whose GDEF marks `B` and `calt` type 5 skips it between `A` and `C`.
@NotNullByDefault
public final class GsubContextMarkSampleFont {
    ...
    private GsubContextMarkSampleFont() {
    }
    ...
    /// Writes lookup 0 (type 5, IgnoreMarks) and lookup 1 (type 1).
    ...
    private static byte[] name() {
        byte[] family = "HimariCaltMark".getBytes(StandardCharsets.US_ASCII);
