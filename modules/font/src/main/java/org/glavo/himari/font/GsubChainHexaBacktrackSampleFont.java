...
@NotNullByDefault
public final class GsubChainHexaBacktrackSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `IHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain6Back".getBytes(StandardCharsets.US_ASCII);
