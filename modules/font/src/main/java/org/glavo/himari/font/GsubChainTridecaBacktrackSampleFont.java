...
@NotNullByDefault
public final class GsubChainTridecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`P` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `PONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain13Back".getBytes(StandardCharsets.US_ASCII);
