...
/// Generates a face whose GPOS `mark` lookup type 5 attaches fatha to ligature `A`.
///
/// The component-0 anchors are `(4, 8)` on the ligature and `(1, 1)` on the mark, so the mark
/// offset is [`#MARK_X_OFFSET`], [`#MARK_Y_OFFSET`].
@NotNullByDefault
public final class GposMarkLigSampleFont {
    /// Isolated ligature advance.
    public static final int ADVANCE_LIGA = 10;
    ...
    /// Ligature glyph mapped from `A`.
    public static final int GLYPH_LIGA = 2;
    ...
    private GposMarkLigSampleFont() {
    }

    /// Builds the mark-to-ligature sample font.
    ///
    ...
    /// Writes a format-4 cmap for space, `A`, and fatha.
    private static byte[] cmap() {
        ...
        buffer.putShort((short) (GLYPH_LIGA - 'A'));
    ...
    private static byte[] gpos() {
        ...
        feature.putShort((short) 0);
        byte[] featureList = featureList(0x6D61726B, feature.array());
    ...
    /// Writes MarkLigPos format 1 with one component.
    private static byte[] markLig() {
        ...
        buffer.putShort((short) 1);
        buffer.putShort((short) 1);
        buffer.putShort((short) GLYPH_LIGA);
        return buffer.array();
    }
    ...
    private static byte[] hhea() {
        ...
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) ADVANCE_LIGA);
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
    ...
    private static byte[] hmtx() {
        ...
        int[] advances = {0, 3, ADVANCE_LIGA, 0};
    ...
    private static byte[] name() {
        byte[] family = "HimariMarkLig".getBytes(StandardCharsets.US_ASCII);
