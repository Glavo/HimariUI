...
@NotNullByDefault
public final class GsubChainDodecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`O` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `ONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain12Back".getBytes(StandardCharsets.US_ASCII);
