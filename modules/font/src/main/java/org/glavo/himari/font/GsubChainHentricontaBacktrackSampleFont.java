...
@NotNullByDefault
public final class GsubChainHentricontaBacktrackSampleFont {
    ...
    private GsubChainHentricontaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`8`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `87654321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain31Back".getBytes(StandardCharsets.US_ASCII);
