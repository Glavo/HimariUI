...
@NotNullByDefault
public final class ColrV1VarSkewYDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default skew Y angle before variation, as `F2DOT14`.
    public static final int BASE_SKEW_Y = 2;

    /// ItemVariationStore delta applied to the Y skew at peak `wght`.
    public static final int SKEW_Y_DELTA = 3;
    ...
    private ColrV1VarSkewYDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        putOffset24(buffer, 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) BASE_SKEW_Y);
        buffer.putInt(0);
