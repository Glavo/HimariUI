...
@NotNullByDefault
public final class GposChainDoubleBacktrackSampleFont {
    /// Isolated letter advance.
    public static final int ADVANCE_LETTER = 10;

    /// Type-8 X-advance applied to `A` in `EDABC`.
    ...
    private GposChainDoubleBacktrackSampleFont() {
    }
    ...
    /// Writes ChainContextPos format 2 for `EDABC`.
    ...
    private static byte[] name() {
        byte[] family = "HimariChain2Back".getBytes(StandardCharsets.US_ASCII);
