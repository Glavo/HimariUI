...
/// Generates a TrueType face whose `A` is a COLR v1 `PaintVarScaleUniform` with a store.
///
...
@NotNullByDefault
public final class ColrV1VarScaleUniformDeltaSampleFont {
    /// `wght` tag.
    ...
    private ColrV1VarScaleUniformDeltaSampleFont() {
    }
