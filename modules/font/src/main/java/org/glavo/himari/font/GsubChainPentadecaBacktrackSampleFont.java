...
@NotNullByDefault
public final class GsubChainPentadecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`R` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `RQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain15Back".getBytes(StandardCharsets.US_ASCII);
