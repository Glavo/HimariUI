...
@NotNullByDefault
public final class GposChainHeptatriacontaBacktrackSampleFont {
    ...
    private static final int GLYPH_COUNT = 42;

    /// Prevents instantiation.
    private GposChainHeptatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariChain37Back".getBytes(StandardCharsets.US_ASCII);
