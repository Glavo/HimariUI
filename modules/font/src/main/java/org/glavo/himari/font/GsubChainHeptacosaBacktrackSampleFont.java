...
@NotNullByDefault
public final class GsubChainHeptacosaBacktrackSampleFont {
    ...
    private GsubChainHeptacosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`4`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `4321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain27Back".getBytes(StandardCharsets.US_ASCII);
