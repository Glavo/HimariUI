...
@NotNullByDefault
public final class GsubChainHenicosaBacktrackSampleFont {
    ...
    private GsubChainHenicosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`X` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `XWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
