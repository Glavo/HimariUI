...
@NotNullByDefault
public final class GsubChainDotricontaBacktrackSampleFont {
    ...
    private GsubChainDotricontaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`9`, and the contiguous `A`–`Z` range.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain32Back".getBytes(StandardCharsets.US_ASCII);
