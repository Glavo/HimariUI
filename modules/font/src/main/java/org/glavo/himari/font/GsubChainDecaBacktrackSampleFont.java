...
@NotNullByDefault
public final class GsubChainDecaBacktrackSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `MLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain10Back".getBytes(StandardCharsets.US_ASCII);
