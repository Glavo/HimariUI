...
@NotNullByDefault
public final class GsubChainPentaBacktrackSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `HGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain5Back".getBytes(StandardCharsets.US_ASCII);
