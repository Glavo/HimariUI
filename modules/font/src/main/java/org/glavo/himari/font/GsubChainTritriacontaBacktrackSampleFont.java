...
@NotNullByDefault
public final class GsubChainTritriacontaBacktrackSampleFont {
    ...
    private GsubChainTritriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain33Back".getBytes(StandardCharsets.US_ASCII);
