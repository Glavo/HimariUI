...
@NotNullByDefault
public final class ColrV1VarTranslateDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default `dx` before variation.
    public static final int BASE_TRANSLATE_X = 2;

    /// ItemVariationStore delta applied to `dx` at peak `wght`.
    public static final int TRANSLATE_DELTA = 3;
    ...
    private ColrV1VarTranslateDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        putOffset24(buffer, 0);
        buffer.putShort((short) BASE_TRANSLATE_X);
        buffer.putShort((short) 0);
        buffer.putInt(0);
        ...
        buffer.putShort((short) 1);
        buffer.putShort((short) 0);
        buffer.put((byte) TRANSLATE_DELTA);
        return slice(buffer);
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariColrVarDx".getBytes(StandardCharsets.US_ASCII);
