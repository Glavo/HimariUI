...
@NotNullByDefault
public final class GsubChainIcosaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`W` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `WVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
