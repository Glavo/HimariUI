...
/// Generates a face whose GPOS type-7 `AB` rule applies [`#CONTEXT_DELTA`] to `A`.
///
/// Lookup 0 is the contextual rule listed by `kern`. Lookup 1 is a type-1 X-advance used only as
/// the nested positioning lookup.
@NotNullByDefault
public final class GposContextSampleFont {
    ...
    /// Writes ContextPos format 1 for `AB`.
    ...
    private static byte[] name() {
        byte[] family = "HimariContext".getBytes(StandardCharsets.US_ASCII);
