...
@NotNullByDefault
public final class GposChainTetratriacontaBacktrackSampleFont {
    ...
    private static final int GLYPH_COUNT = 39;

    /// Prevents instantiation.
    private GposChainTetratriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] cmap() {
        ByteBuffer buffer = ByteBuffer.allocate(102).order(ByteOrder.BIG_ENDIAN);
    ...
    private static byte[] name() {
        byte[] family = "HimariChain34Back".getBytes(StandardCharsets.US_ASCII);
