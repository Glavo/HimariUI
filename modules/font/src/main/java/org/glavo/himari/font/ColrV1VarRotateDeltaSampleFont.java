...
/// is `5`.
@NotNullByDefault
public final class ColrV1VarRotateDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default rotate angle before variation, as `F2DOT14`.
    public static final int BASE_ROTATE = 2;

    /// ItemVariationStore delta applied to the angle at peak `wght`.
    public static final int ROTATE_DELTA = 3;
    ...
    private ColrV1VarRotateDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        putOffset24(buffer, 0);
        buffer.putShort((short) BASE_ROTATE);
        buffer.putInt(0);
    ...
    private static byte[] name() {
        byte[] family = "HimariColrVarAng".getBytes(StandardCharsets.US_ASCII);
