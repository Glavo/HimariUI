...
@NotNullByDefault
public final class GsubChainTetratriacontaBacktrackSampleFont {
    ...
    private GsubChainTetratriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain34Back".getBytes(StandardCharsets.US_ASCII);
