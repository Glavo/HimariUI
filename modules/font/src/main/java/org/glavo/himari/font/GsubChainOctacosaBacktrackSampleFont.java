...
@NotNullByDefault
public final class GsubChainOctacosaBacktrackSampleFont {
    ...
    private GsubChainOctacosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`5`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `54321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain28Back".getBytes(StandardCharsets.US_ASCII);
