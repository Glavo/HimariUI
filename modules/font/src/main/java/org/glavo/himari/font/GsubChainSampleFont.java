...
/// Generates a face whose GSUB `calt` type-6 rule turns `A` into `Y` before `BC`.
@NotNullByDefault
public final class GsubChainSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `ABC`.
    ...
    private static byte[] name() {
        byte[] family = "HimariChainCalt".getBytes(StandardCharsets.US_ASCII);
