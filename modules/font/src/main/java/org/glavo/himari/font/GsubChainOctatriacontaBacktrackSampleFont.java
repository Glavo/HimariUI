...
@NotNullByDefault
public final class GsubChainOctatriacontaBacktrackSampleFont {
    ...
    private GsubChainOctatriacontaBacktrackSampleFont() {
    }
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain38Back".getBytes(StandardCharsets.US_ASCII);
