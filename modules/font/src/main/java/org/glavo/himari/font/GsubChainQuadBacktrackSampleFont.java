...
@NotNullByDefault
public final class GsubChainQuadBacktrackSampleFont {
    ...
    /// Writes ChainContextSubst format 1 for `GFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain4Back".getBytes(StandardCharsets.US_ASCII);
