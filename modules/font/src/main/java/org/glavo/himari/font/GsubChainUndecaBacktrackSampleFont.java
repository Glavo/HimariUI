...
@NotNullByDefault
public final class GsubChainUndecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`M` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `NMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain11Back".getBytes(StandardCharsets.US_ASCII);
