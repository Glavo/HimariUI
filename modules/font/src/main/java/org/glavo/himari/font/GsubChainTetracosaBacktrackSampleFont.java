...
@NotNullByDefault
public final class GsubChainTetracosaBacktrackSampleFont {
    ...
    private GsubChainTetracosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`1`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `1ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain24Back".getBytes(StandardCharsets.US_ASCII);
