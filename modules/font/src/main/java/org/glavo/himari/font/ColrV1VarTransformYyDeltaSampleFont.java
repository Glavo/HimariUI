...
///
/// Glyph 2 is the empty base. Glyph 3 is the painted rectangle. Default `yy` is `2`. Peak
/// `wght` applies an ItemVariationStore delta of `3` so [`ColorLayer#transformYy()`] is `5`.
@NotNullByDefault
public final class ColrV1VarTransformYyDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default transform `yy` before variation, as `16.16` units.
    public static final int BASE_TRANSFORM_YY = 2;
    ...
    private ColrV1VarTransformYyDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        buffer.putInt(0);
        buffer.putInt(0);
        buffer.putInt(BASE_TRANSFORM_YY);
        buffer.putInt(0);
        buffer.putInt(0);
        buffer.putInt(0);
