...
/// Generates a face whose GSUB `calt` type-8 rule turns `A` into `X` before `B`.
@NotNullByDefault
public final class GsubReverseSampleFont {
    ...
    /// Writes ReverseChainSingleSubst format 1 for `AB`.
    ...
    private static byte[] name() {
        byte[] family = "HimariReverse".getBytes(StandardCharsets.US_ASCII);
