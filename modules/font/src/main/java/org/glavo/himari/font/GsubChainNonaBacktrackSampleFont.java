...
@NotNullByDefault
public final class GsubChainNonaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`G` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `LKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain9Back".getBytes(StandardCharsets.US_ASCII);
