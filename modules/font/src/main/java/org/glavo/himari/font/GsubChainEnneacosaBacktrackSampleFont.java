...
@NotNullByDefault
public final class GsubChainEnneacosaBacktrackSampleFont {
    ...
    private GsubChainEnneacosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`6`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `654321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain29Back".getBytes(StandardCharsets.US_ASCII);
