...
@NotNullByDefault
public final class GsubChainPentacosaBacktrackSampleFont {
    ...
    private GsubChainPentacosaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`2`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `21ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain25Back".getBytes(StandardCharsets.US_ASCII);
