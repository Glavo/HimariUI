...
/// Generates a TrueType face with one `wght` axis and an `MVAR` `hasc` delta.
///
/// The default `hhea` ascender is [`#DEFAULT_ASCENDER`]. At peak weight `900` `MVAR` adds
/// [`#ASCENDER_DELTA`].
@NotNullByDefault
public final class MvarSampleFont {
    /// `wght` tag.
    ...
    /// Default `hhea` ascender.
    public static final int DEFAULT_ASCENDER = 7;

    /// Peak `MVAR` `hasc` delta.
    public static final int ASCENDER_DELTA = 8;
    ...
    private MvarSampleFont() {
    }

    /// Builds the MVAR sample font.
    ///
    ...
    /// Builds the MVAR sample font image.
    ///
    ...
    /// Writes one `hasc` value record and a peak 8-bit delta.
    private static byte[] mvar() {
        ...
        buffer.putShort((short) 1);
        buffer.putShort((short) 20);
        buffer.putInt(MvarTable.TAG_HASC);
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) 1);
        buffer.putInt(12);
        ...
        buffer.putShort((short) 1);
        buffer.putShort((short) 0);
        buffer.put((byte) ASCENDER_DELTA);
        return buffer.array();
    }
    ...
    private static byte[] hhea() {
        ByteBuffer buffer = ByteBuffer.allocate(36).order(ByteOrder.BIG_ENDIAN);
        buffer.putInt(0x00010000);
        buffer.putShort((short) DEFAULT_ASCENDER);
        buffer.putShort((short) 0);
        buffer.putShort((short) 0);
        buffer.putShort((short) 8);
        buffer.putShort((short) 0);
    ...
    private static byte[] name() {
        byte[] family = "HimariMvar".getBytes(StandardCharsets.US_ASCII);
