...
@NotNullByDefault
public final class GsubChainBacktrackSampleFont {
    ...
    private GsubChainBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, `A`, `B`, `C`, `D`, and `Y`.
    ...
    /// Writes ChainContextSubst format 2 for `DABC` using backtrack class 1.
    ...
    private static byte[] hmtx() {
        ...
        int[] advances = {0, 3, ADVANCE_LETTER, ADVANCE_LETTER, ADVANCE_LETTER, ADVANCE_LETTER, ADVANCE_Y};
    ...
    private static byte[] name() {
        byte[] family = "HimariChBackGsub".getBytes(StandardCharsets.US_ASCII);
