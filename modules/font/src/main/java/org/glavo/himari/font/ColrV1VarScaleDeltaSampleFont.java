...
/// [`ColorLayer#scaleX()`] is `0x4003`.
@NotNullByDefault
public final class ColrV1VarScaleDeltaSampleFont {
    /// `wght` tag.
    ...
    /// Default `scaleX` before variation, as `F2DOT14` `1.0`.
    public static final int BASE_SCALE_X = 0x4000;
    ...
    private ColrV1VarScaleDeltaSampleFont() {
    }
    ...
    private static byte[] colr() {
        ...
        putOffset24(buffer, 0);
        buffer.putShort((short) BASE_SCALE_X);
        buffer.putShort((short) BASE_SCALE_X);
        buffer.putInt(0);
    ...
    private static byte[] name() {
        byte[] family = "HimariColrVarSx".getBytes(StandardCharsets.US_ASCII);
