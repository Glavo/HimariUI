...
@NotNullByDefault
public final class GsubChainTriacontaBacktrackSampleFont {
    ...
    private GsubChainTriacontaBacktrackSampleFont() {
    }
    ...
    /// Writes a format-4 cmap for space, digits `0`–`7`, and the contiguous `A`–`Z` range.
    ...
    /// Writes ChainContextSubst format 1 for `7654321ZYXWVUTSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain30Back".getBytes(StandardCharsets.US_ASCII);
