...
@NotNullByDefault
public final class GsubChainHeptadecaBacktrackSampleFont {
    ...
    /// Writes a format-4 cmap for space, the contiguous `A`–`T` range, and `Y`.
    ...
    /// Writes ChainContextSubst format 1 for `TSRQPONMLKJIHGFEDABC`. Coverage sits after the rule.
    ...
    private static byte[] name() {
        byte[] family = "HimariGsubChain17Back".getBytes(StandardCharsets.US_ASCII);
