...
/// Verifies thirty-two-glyph GSUB chain backtrack through [`SfntFont#chainSubstitute(int[], int, int, int)`].
@NotNullByDefault
final class GsubChainDotricontaBacktrackTest {
    ...
    void format1BacktrackRequiresNineEightSevenSixFiveFourThreeTwoOneZyxwvutsrqponmlkjihgfed() {
        SfntFont font = GsubChainDotricontaBacktrackSampleFont.create();
        ...
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_Y, y);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_Z, z);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_ZERO, zero);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_ONE, one);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_TWO, two);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_THREE, three);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_FOUR, four);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_FIVE, five);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_SIX, six);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_SEVEN, seven);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_EIGHT, eight);
        assertEquals(GsubChainDotricontaBacktrackSampleFont.GLYPH_NINE, nine);
        ...
        assertEquals(
                a,
                font.chainSubstitute(
                        new int[] {nine, seven, six, five, four, three, two, one, z, y, x, w, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, a, b, c},
                        31,
                        3,
                        SfntFont.TAG_CALT
                )
