...
/// Verifies twenty-one-glyph GSUB chain backtrack through [`SfntFont#chainSubstitute(int[], int, int, int)`].
@NotNullByDefault
final class GsubChainHenicosaBacktrackTest {
    /// Substitutes `A` only when format-1 backtrack `XWVUTSRQPONMLKJIHGFED` and lookahead `BC` are present.
    @Test
    void format1BacktrackRequiresXwvutsrqponmlkjihgfed() {
        SfntFont font = GsubChainHenicosaBacktrackSampleFont.create();
        ...
        assertEquals(GsubChainHenicosaBacktrackSampleFont.GLYPH_X, x);
        assertEquals(GsubChainHenicosaBacktrackSampleFont.GLYPH_Y, y);
        ...
        assertEquals(
                a,
                font.chainSubstitute(
                        new int[] {x, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, a, b, c},
                        20,
                        3,
                        SfntFont.TAG_CALT
                )
