...
/// Verifies nineteen-glyph GSUB chain backtrack through [`SfntFont#chainSubstitute(int[], int, int, int)`].
@NotNullByDefault
final class GsubChainEnneadecaBacktrackTest {
    /// Substitutes `A` only when format-1 backtrack `VUTSRQPONMLKJIHGFED` and lookahead `BC` are present.
    @Test
    void format1BacktrackRequiresVutsrqponmlkjihgfed() {
        SfntFont font = GsubChainEnneadecaBacktrackSampleFont.create();
        ...
        assertEquals(GsubChainEnneadecaBacktrackSampleFont.GLYPH_V, v);
        assertEquals(GsubChainEnneadecaBacktrackSampleFont.GLYPH_Y, y);
        ...
        assertEquals(
                a,
                font.chainSubstitute(
                        new int[] {v, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, a, b, c},
                        18,
                        3,
                        SfntFont.TAG_CALT
                )
