...
/// Verifies twenty-two-glyph GPOS chain backtrack through [`SfntFont#chainAdjustment(int[], int, int)`].
@NotNullByDefault
final class GposChainDocosaBacktrackTest {
    /// Applies the format-1 chain only when backtrack `YXWVUTSRQPONMLKJIHGFED` precedes `ABC`.
    @Test
    void format1BacktrackRequiresYxwvutsrqponmlkjihgfed() {
        SfntFont font = GposChainDocosaBacktrackSampleFont.create();
        ...
        assertEquals(GposChainDocosaBacktrackSampleFont.GLYPH_Y, y);
        ...
        assertEquals(
                0,
                font.chainAdjustment(new int[] {x, w, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, a, b, c}, 21, 3)
        );
        assertEquals(
                0,
                font.chainAdjustment(new int[] {y, w, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, a, b, c}, 21, 3)
        );
    }
}
